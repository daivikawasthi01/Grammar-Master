    ...
    return (
        <div className={styles.start__main} style={{ backgroundColor: bgColor, color: color }}>
            <div className={styles.start__main__left}>
                ...
                <div>
                    <button className={styles.start__left__register}>
                ...
                <p data-testid='policy' className={styles.start__left__policy}>
                    By signing up, you agree to the <Link href='/'>Terms and Conditions</Link> and <Link href='/'>Privacy Policy</Link>. California residents, see our <Link href='/'>CA Privacy Notice.</Link>
                </p>
            </div>
